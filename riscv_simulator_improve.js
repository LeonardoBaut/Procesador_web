...
class RISCVSimulator {
    ...
    drawDatapath() {
        ...
        const components = {
            ...
            pc: { x: 30, y: 280, w: 50, h: 40, label: 'PC', type: 'register' },
            pcMux: { x: 90, y: 200, w: 25, h: 50, label: '', type: 'mux' },
            pcAdder4: { x: 100, y: 340, w: 35, h: 35, label: '+4', type: 'adder' },
            branchAdder: { x: 100, y: 425, w: 35, h: 35, label: '+', type: 'adder' },
            
            // Memoria de instrucciones
            instructionMemory: { x: 180, y: 50, w: 130, h: 300, label: 'Memoria de\nPrograma', type: 'memory' },
            
            // Order y Sign Extend
            orderUnit: { x: 180, y: 380, w: 90, h: 45, label: 'Orden &\nSign Extend', type: 'logic' },
            
            // Multiplexor pequeño
            muxImmRd: { x: 340, y: 170, w: 22, h: 45, label: '', type: 'mux' },
            
            // Sign Extend
            signExtend: { x: 330, y: 80, w: 80, h: 55, label: 'Sign\nExtend', type: 'logic' },
            
            // Banco de registros
            registerBank: { x: 420, y: 170, w: 145, h: 200, label: 'Banco de\nRegistros\n(RF)', type: 'register' },
            
            // MUX ALU_SRC
            muxALUSrc: { x: 635, y: 300, w: 28, h: 60, label: '', type: 'mux' },
            
            // ALU
            alu: { x: 730, y: 230, w: 90, h: 130, label: 'ALU', type: 'alu' },
            
            // MUX ALU2REG
            muxALU2Reg: { x: 865, y: 210, w: 28, h: 60, label: '', type: 'mux' },
            
            // Memoria de datos
            dataMemory: { x: 950, y: 110, w: 110, h: 220, label: 'Memoria de\nDatos\n(DM)', type: 'memory' },
            
            // Unidad de Control
            controlUnit: { x: 380, y: 480, w: 180, h: 90, label: 'Unidad de Control (CU)', type: 'control' }
        };
